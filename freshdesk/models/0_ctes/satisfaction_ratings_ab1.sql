...
-- depends_on: {{ source('freshdesk_partner_a', '_airbyte_raw_satisfaction_ratings') }}
select
...
from {{ source('freshdesk_partner_a', '_airbyte_raw_satisfaction_ratings') }} as table_alias
