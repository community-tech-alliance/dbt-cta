...
with
    ...
    __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_van_locations_ab2 as (
    ...
    __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_van_locations_ab3 as (

        -- SQL model to build a hash column based on the values of this record
        -- depends_on:
        -- __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_van_locations_ab2
        select
            to_hex(
                md5(
                    cast(
            ...
            tmp.*
        from
            __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_van_locations_ab2 tmp
        -- van_locations
        where 1 = 1

    )  -- Final base SQL model
-- depends_on:
-- __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_van_locations_ab3
select
    id,
    van_id,
    event_id,
...
from __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_van_locations_ab3
