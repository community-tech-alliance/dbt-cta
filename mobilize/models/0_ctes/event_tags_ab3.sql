...
-- depends_on: __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_event_tags_ab2
select
    to_hex(
        md5(
            cast(
    ...
    tmp.*
from __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_event_tags_ab2 tmp
-- event_tags
where 1 = 1
