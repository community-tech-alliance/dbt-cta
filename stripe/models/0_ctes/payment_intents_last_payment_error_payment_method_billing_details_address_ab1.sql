...
-- depends_on: {{ ref('payment_intents_last_payment_error_payment_method_billing_details') }}
select
...
from {{ ref('payment_intents_last_payment_error_payment_method_billing_details') }} as table_alias
