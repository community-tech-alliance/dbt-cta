...
-- depends_on: {{ ref('subscription_items_plan') }}
{{ unnest_cte(ref('subscription_items_plan'), 'plan', 'tiers') }}
select
...
from {{ ref('subscription_items_plan') }} as table_alias
-- tiers at subscription_items/plan/tiers
