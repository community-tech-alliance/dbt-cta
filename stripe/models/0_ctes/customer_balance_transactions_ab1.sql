...
-- depends_on: {{ source('stripe_partner_a', '_airbyte_raw_customer_balance_transactions') }}
select
...
from {{ source('stripe_partner_a', '_airbyte_raw_customer_balance_transactions') }} as table_alias
