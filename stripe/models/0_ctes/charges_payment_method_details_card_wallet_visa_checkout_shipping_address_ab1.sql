...
-- depends_on: {{ ref('charges_payment_method_details_card_wallet_visa_checkout') }}
select
...
from {{ ref('charges_payment_method_details_card_wallet_visa_checkout') }} as table_alias
-- shipping_address at charges/payment_method_details/card/wallet/visa_checkout/shipping_address
where 1 = 1
