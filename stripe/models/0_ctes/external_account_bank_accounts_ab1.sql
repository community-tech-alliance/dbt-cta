...
-- depends_on: {{ source('stripe_partner_a', '_airbyte_raw_external_account_bank_accounts') }}
select
...
from {{ source('stripe_partner_a', '_airbyte_raw_external_account_bank_accounts') }} as table_alias
