...
-- depends_on: {{ ref('payment_intents_last_payment_error_payment_method_card_wallet') }}
select
...
from {{ ref('payment_intents_last_payment_error_payment_method_card_wallet') }} as table_alias
