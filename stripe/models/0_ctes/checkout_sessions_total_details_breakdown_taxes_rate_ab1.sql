...
-- depends_on: {{ ref('checkout_sessions_total_details_breakdown_taxes') }}
select
...
from {{ ref('checkout_sessions_total_details_breakdown_taxes') }} as table_alias
-- rate at checkout_sessions/total_details/breakdown/taxes/rate
where 1 = 1
