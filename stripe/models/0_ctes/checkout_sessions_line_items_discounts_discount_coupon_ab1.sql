...
-- depends_on: {{ ref('checkout_sessions_line_items_discounts_discount') }}
select
    ...
    {{ json_extract('table_alias', 'coupon', ['applies_to'], ['applies_to']) }} as applies_to,
...
from {{ ref('checkout_sessions_line_items_discounts_discount') }} as table_alias
