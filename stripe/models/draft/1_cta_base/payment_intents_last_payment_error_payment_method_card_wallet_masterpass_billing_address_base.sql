...
-- billing_address at payment_intents/last_payment_error/payment_method/card/wallet/masterpass/billing_address from {{ ref('payment_intents_last_payment_error_payment_method_card_wallet_masterpass') }}
where 1 = 1
