...
-- billing_address at charges/payment_method_details/card/wallet/visa_checkout/billing_address from {{ ref('charges_payment_method_details_card_wallet_visa_checkout') }}
where 1 = 1
