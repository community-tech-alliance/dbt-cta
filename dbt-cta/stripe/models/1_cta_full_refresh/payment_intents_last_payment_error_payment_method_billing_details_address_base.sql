...
-- address at payment_intents_base/last_payment_error/payment_method/billing_details/address from {{ ref('payment_intents_last_payment_error_payment_method_billing_details_base') }}
{% if is_incremental() %}
