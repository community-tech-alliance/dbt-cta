...
-- generated_from at payment_intents_base/last_payment_error/payment_method/sepa_debit/generated_from from {{ ref('payment_intents_last_payment_error_payment_method_sepa_debit_base') }}
{% if is_incremental() %}
