...
-- billing_address at payment_intents_base/last_payment_error/payment_method/card/wallet/visa_checkout/billing_address from {{ ref('payment_intents_last_payment_error_payment_method_card_wallet_visa_checkout_base') }}
{% if is_incremental() %}
