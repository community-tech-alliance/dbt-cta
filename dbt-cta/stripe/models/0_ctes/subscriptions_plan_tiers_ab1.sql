...
-- depends_on: {{ ref('subscriptions_plan_base') }}
{{ unnest_cte(ref('subscriptions_plan_base'), 'plan', 'tiers') }}
select
...
from {{ ref('subscriptions_plan_base') }} as table_alias
-- tiers at subscriptions_base/plan/tiers
