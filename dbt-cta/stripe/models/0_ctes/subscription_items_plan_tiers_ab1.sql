...
-- depends_on: {{ ref('subscription_items_plan_base') }}
{{ unnest_cte(ref('subscription_items_plan_base'), 'plan', 'tiers') }}
select
...
from {{ ref('subscription_items_plan_base') }} as table_alias
-- tiers at subscription_items_base/plan/tiers
