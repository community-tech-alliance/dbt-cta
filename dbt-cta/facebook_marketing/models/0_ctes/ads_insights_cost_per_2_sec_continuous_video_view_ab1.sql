...
{{ unnest_cte(ref('ads_insights_ab3'), 'ads_insights_ab3', 'cost_per_2_sec_continuous_video_view') }}
select
...
-- cost_per_2_sec_continuous_video_view at ads_insights/cost_per_2_sec_continuous_video_view
{{ cross_join_unnest('ads_insights_ab3', 'cost_per_2_sec_continuous_video_view') }}
where 1 = 1
