...
{{ unnest_cte(ref('ads_insights_ab3'), 'ads_insights_ab3', 'cost_per_thruplay') }}
select
...
-- cost_per_thruplay at ads_insights/cost_per_thruplay
{{ cross_join_unnest('ads_insights_ab3', 'cost_per_thruplay') }}
where 1 = 1
