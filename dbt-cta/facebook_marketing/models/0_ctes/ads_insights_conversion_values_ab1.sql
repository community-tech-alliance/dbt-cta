...
{{ unnest_cte(ref('ads_insights_ab3'), 'ads_insights_ab3', 'conversion_values') }}
select
...
-- conversion_values at ads_insights/conversion_values
{{ cross_join_unnest('ads_insights_ab3', 'conversion_values') }}
where 1 = 1
