...
{{ unnest_cte(ref('ads_insights_ab3'), 'ads_insights_ab3', 'video_p100_watched_actions') }}
select
...
-- video_p100_watched_actions at ads_insights/video_p100_watched_actions
{{ cross_join_unnest('ads_insights_ab3', 'video_p100_watched_actions') }}
where 1 = 1
