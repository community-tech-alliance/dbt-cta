...
-- depends_on: {{ ref('recordings_ab4') }}
select
    ab3.*
from {{ ref('recordings_ab3') }} as ab3
join {{ ref('recordings_ab4') }} as ab4 
    on ab3._airbyte_recordings_hashid = ab4._airbyte_recordings_hashid
