...
select
    ...
    cast(bundle_sid as {{ dbt_utils.type_string() }}) as bundle_sid,
    cast(sms_method as {{ dbt_utils.type_string() }}) as sms_method,
    cast(account_sid as {{ dbt_utils.type_string() }}) as account_sid,
    cast(address_sid as {{ dbt_utils.type_string() }}) as address_sid,
    ...
    cast(identity_sid as {{ dbt_utils.type_string() }}) as identity_sid,
    ...
    cast(voice_receive_mode as {{ dbt_utils.type_string() }}) as voice_receive_mode,
    ...
    cast(emergency_address_status as {{ dbt_utils.type_string() }}) as emergency_address_status,
    _airbyte_ab_id,
    _airbyte_emitted_at,
