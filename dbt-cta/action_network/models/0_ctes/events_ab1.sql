...
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['rsvp_goal'], ['rsvp_goal']) }} as rsvp_goal,
    ...
    {{ json_extract_scalar('_airbyte_data', ['rsvp_count'], ['rsvp_count']) }} as rsvp_count,
    {{ json_extract_scalar('_airbyte_data', ['rsvp_limit'], ['rsvp_limit']) }} as rsvp_limit,
    ...
    {{ json_extract_scalar('_airbyte_data', ['allow_guests'], ['allow_guests']) }} as allow_guests,
    ...
    {{ json_extract_scalar('_airbyte_data', ['event_upload_id'], ['event_upload_id']) }} as event_upload_id,
