{% set raw_table = env_var("CTA_DATASET_ID", "not-set") ~ "_raw__stream_share_options" %}
...
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['bcc'], ['bcc']) }} as bcc,
    ...
    {{ json_extract_scalar('_airbyte_data', ['bluesky_share'], ['bluesky_share']) }} as bluesky_share,
    ...
    {{ json_extract_scalar('_airbyte_data', ['mobile_response'], ['mobile_response']) }} as mobile_response,
    ...
    {{ json_extract_scalar('_airbyte_data', ['mobile_response_body'], ['mobile_response_body']) }} as mobile_response_body,
