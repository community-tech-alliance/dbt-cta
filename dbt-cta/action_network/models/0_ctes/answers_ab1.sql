...
-- depends_on: {{ source('cta', '_airbyte_raw_answers') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['form_id'], ['form_id']) }} as form_id,
...
from {{ source('cta', '_airbyte_raw_answers') }} as table_alias
-- answers
where 1 = 1
