...
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['answer_goal'], ['answer_goal']) }} as answer_goal,
    ...
    {{ json_extract_scalar('_airbyte_data', ['answer_count'], ['answer_count']) }} as answer_count,
    {{ json_extract_scalar('_airbyte_data', ['form_heading'], ['form_heading']) }} as form_heading,
