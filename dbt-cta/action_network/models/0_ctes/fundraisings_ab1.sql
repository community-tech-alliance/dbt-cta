...
-- depends_on: {{ source('cta', '_airbyte_raw_fundraisings') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['amounts'], ['amounts']) }} as amounts,
    ...
    {{ json_extract_scalar('_airbyte_data', ['donation_goal'], ['donation_goal']) }} as donation_goal,
    ...
    {{ json_extract_scalar('_airbyte_data', ['donation_count'], ['donation_count']) }} as donation_count,
    ...
    {{ json_extract_scalar('_airbyte_data', ['recurring_upsell'], ['recurring_upsell']) }} as recurring_upsell,
    {{ json_extract_scalar('_airbyte_data', ['image_attribution'], ['image_attribution']) }} as image_attribution,
    {{ json_extract_scalar('_airbyte_data', ['recurring_options'], ['recurring_options']) }} as recurring_options,
    ...
    {{ json_extract_scalar('_airbyte_data', ['recurring_upsell_description'], ['recurring_upsell_description']) }} as recurring_upsell_description,
    _airbyte_ab_id,
    _airbyte_emitted_at,
    {{ current_timestamp() }} as _airbyte_normalized_at
from {{ source('cta', '_airbyte_raw_fundraisings') }} as table_alias
-- fundraisings
where 1 = 1
