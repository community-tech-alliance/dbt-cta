...
-- depends_on: {{ source('cta', '_airbyte_raw_signatures') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['petition_id'], ['petition_id']) }} as petition_id,
...
from {{ source('cta', '_airbyte_raw_signatures') }} as table_alias
-- signatures
where 1 = 1
