{% set raw_table = env_var("CTA_DATASET_ID", "not-set") ~ "_raw__stream_letter_templates" %}
...
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['hide_signer_personal_information'], ['hide_signer_personal_information']) }} as hide_signer_personal_information,
    _airbyte_raw_id,
