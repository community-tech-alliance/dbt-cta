...
-- depends_on: {{ source('cta', '_airbyte_raw_donations') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['total_amount'], ['total_amount']) }} as total_amount,
...
from {{ source('cta', '_airbyte_raw_donations') }} as table_alias
-- donations
where 1 = 1
