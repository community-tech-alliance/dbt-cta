...
with
    ...
    __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_event_co_hosts_ab2 as (
    ...
    __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_event_co_hosts_ab3 as (

        -- SQL model to build a hash column based on the values of this record
        -- depends_on:
        -- __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_event_co_hosts_ab2
        select
            to_hex(
                md5(
                    cast(
            ...
            tmp.*
        from
            __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_event_co_hosts_ab2 tmp
        -- event_co_hosts
        where 1 = 1

    )  -- Final base SQL model
-- depends_on:
-- __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_event_co_hosts_ab3
select
    id,
    email,
    user_id,
...
from __dbt__cte___airbyte_org_7e6abb14a314439581d38bb69eaa0083_event_co_hosts_ab3
...
-- before edits: 12 records in base, 12 in partner
