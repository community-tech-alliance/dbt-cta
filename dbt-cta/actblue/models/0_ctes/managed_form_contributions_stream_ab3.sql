...
-- depends_on: {{ ref('managed_form_contributions_stream_ab2') }}
select
    ...
    ]) }} as _airbyte_managed_form_contributions_stream_hashid,
    tmp.*
from {{ ref('managed_form_contributions_stream_ab2') }} as tmp
