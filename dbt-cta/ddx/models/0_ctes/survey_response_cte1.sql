...
select
    ...
    cast(aggregated_exchange_survey_question_code as string) as aggregated_exchange_survey_question_code,
    cast(aggregated_exchange_survey_question_response_name as string) as aggregated_exchange_survey_question_response_name,
