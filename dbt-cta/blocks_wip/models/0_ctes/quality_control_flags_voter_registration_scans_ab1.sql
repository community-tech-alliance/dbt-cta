...
-- depends_on: {{ source('sv_blocks', '_airbyte_raw_quality_control_flags_voter_registration_scans') }}
select
...
from {{ source('sv_blocks', '_airbyte_raw_quality_control_flags_voter_registration_scans') }} as table_alias
