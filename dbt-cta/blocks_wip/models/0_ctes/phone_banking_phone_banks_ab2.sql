...
select
    ...
    cast({{ empty_string_to_null('daily_end_time') }} as {{ type_time_without_timezone() }}) as daily_end_time,
    ...
    cast({{ empty_string_to_null('daily_start_time') }} as {{ type_time_without_timezone() }}) as daily_start_time,
