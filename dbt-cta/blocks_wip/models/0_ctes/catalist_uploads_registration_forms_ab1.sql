...
-- depends_on: {{ source('sv_blocks', '_airbyte_raw_catalist_uploads_registration_forms') }}
select
...
from {{ source('sv_blocks', '_airbyte_raw_catalist_uploads_registration_forms') }} as table_alias
