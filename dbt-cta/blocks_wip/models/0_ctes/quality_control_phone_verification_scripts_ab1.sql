...
-- depends_on: {{ source('sv_blocks', '_airbyte_raw_quality_control_phone_verification_scripts') }}
select
...
from {{ source('sv_blocks', '_airbyte_raw_quality_control_phone_verification_scripts') }} as table_alias
