...
-- depends_on: {{ ref('vendor_credits_Line_AccountBasedExpenseLineDetail_AccountRef_ab4') }}
select
...
from {{ ref('vendor_credits_Line_AccountBasedExpenseLineDetail_AccountRef_ab4') }}
