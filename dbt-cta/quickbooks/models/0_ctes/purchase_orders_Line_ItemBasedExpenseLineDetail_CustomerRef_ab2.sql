...
-- depends_on: {{ ref('purchase_orders_Line_ItemBasedExpenseLineDetail_CustomerRef_ab1') }}
select
...
from {{ ref('purchase_orders_Line_ItemBasedExpenseLineDetail_CustomerRef_ab1') }}
