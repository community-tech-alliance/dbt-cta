...
-- depends_on: {{ ref('invoices_TxnTaxDetail_base') }}
{{ unnest_cte(ref('invoices_TxnTaxDetail_base'), 'TxnTaxDetail', 'TaxLine_base') }}
select
...
from {{ ref('invoices_TxnTaxDetail_base') }} as table_alias
