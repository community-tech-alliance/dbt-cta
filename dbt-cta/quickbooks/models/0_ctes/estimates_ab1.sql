...
-- depends_on: {{ source('cta', '_airbyte_raw_estimates') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['TxnStatus'], ['TxnStatus']) }} as TxnStatus,
...
from {{ source('cta', '_airbyte_raw_estimates') }} as table_alias
-- estimates
where 1 = 1
