...
-- depends_on: {{ source('cta', '_airbyte_raw_activity_events') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['datetime'], ['datetime']) }} as datetime,
...
from {{ source('cta', '_airbyte_raw_activity_events') }} as table_alias
-- activity_events
where 1 = 1
