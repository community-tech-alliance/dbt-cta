...
-- depends_on: {{ source('cta', '_airbyte_raw_emails') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['email_type'], ['email_type']) }} as email_type,
...
from {{ source('cta', '_airbyte_raw_emails') }} as table_alias
-- emails
where 1 = 1
