...
-- depends_on: {{ source('cta', '_raw_redshift_people_truefalse_conversations') }}
...
select
    ...
    {{ dbt_utils.surrogate_key([
        ...
        'partition_name',
    ]) }} as _redshift_people_truefalse_conversations_hashid,
    {{ current_timestamp() }} as _cta_loaded_at
from {{ source('cta', '_raw_redshift_people_truefalse_conversations') }} as table_alias
where 1 = 1
