...
-- depends_on: {{ ref('redshift_people_truefalse_conversations_cte2') }}
select
    of_people_id,
    conversation_id,
    conversation_time,
    ...
    partition_name,
    _redshift_people_truefalse_conversations_hashid,
    _cta_loaded_at
from {{ ref('redshift_people_truefalse_conversations_cte2') }}
