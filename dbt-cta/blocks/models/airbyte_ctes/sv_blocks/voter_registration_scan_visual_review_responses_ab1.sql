...
-- depends_on: {{ source('sv_blocks', '_airbyte_raw_voter_registration_scan_visual_review_responses') }}
select
...
from {{ source('sv_blocks', '_airbyte_raw_voter_registration_scan_visual_review_responses') }} as table_alias
