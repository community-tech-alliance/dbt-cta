...
-- depends_on: {{ source('cta', '_airbyte_raw_quality_control_phone_verification_question_translations') }}
select
...
from {{ source('cta', '_airbyte_raw_quality_control_phone_verification_question_translations') }} as table_alias
