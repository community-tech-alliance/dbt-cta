...
-- depends_on: {{ source('cta', '_airbyte_raw_voter_registration_scan_batch_cover_sheets') }}
select
...
from {{ source('cta', '_airbyte_raw_voter_registration_scan_batch_cover_sheets') }} as table_alias
