...
-- depends_on: {{ ref('orders_returns_return_line_items_variation_total_price_money_ab1') }}
select
...
from {{ ref('orders_returns_return_line_items_variation_total_price_money_ab1') }}
