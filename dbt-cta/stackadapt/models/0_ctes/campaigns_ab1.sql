...
select
    ...
    json_extract(_airbyte_data, "$['day_part']") as day_part,
    ...
    {{ json_extract_scalar('_airbyte_data', ['ip_options'], ['ip_options']) }} as ip_options,
    ...
    {{ json_extract_array('_airbyte_data', ['device_os_options'], ['device_os_options']) }} as device_os_options,
    {{ json_extract_array('_airbyte_data', ['uk_county_options'], ['uk_county_options']) }} as uk_county_options,
    {{ json_extract_array('_airbyte_data', ['conversion_trackers'], ['conversion_trackers']) }} as conversion_trackers,
    ...
    {{ json_extract_array('_airbyte_data', ['connection_type_options'], ['connection_type_options']) }} as connection_type_options,
    {{ json_extract_array('_airbyte_data', ['device_os_family_options'], ['device_os_family_options']) }} as device_os_family_options,
    _airbyte_raw_id,
