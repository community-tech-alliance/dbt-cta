...
-- depends_on: {{ source('public', '_airbyte_raw_assignable_needs_reply_with_escalation_tags') }}
select
...
from {{ source('public', '_airbyte_raw_assignable_needs_reply_with_escalation_tags') }} as table_alias
