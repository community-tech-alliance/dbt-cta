...
-- depends_on: {{ source('public', '_airbyte_raw_pg_stat_kcache_detail') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['rolname'], ['rolname']) }} as rolname,
...
from {{ source('public', '_airbyte_raw_pg_stat_kcache_detail') }} as table_alias
