...
-- depends_on: {{ source('public', '_airbyte_raw_assignable_campaigns_with_needs_reply') }}
select
...
from {{ source('public', '_airbyte_raw_assignable_campaigns_with_needs_reply') }} as table_alias
