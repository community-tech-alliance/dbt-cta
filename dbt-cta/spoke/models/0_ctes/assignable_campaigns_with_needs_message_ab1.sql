...
-- depends_on: {{ source('public', '_airbyte_raw_assignable_campaigns_with_needs_message') }}
select
...
from {{ source('public', '_airbyte_raw_assignable_campaigns_with_needs_message') }} as table_alias
