...
-- depends_on: {{ ref('ads_insights_platform_and_device_video_p25_watched_actions_ab1') }}
select
...
from {{ ref('ads_insights_platform_and_device_video_p25_watched_actions_ab1') }}
-- video_p25_watched_actions at ads_insights_platform_and_device/video_p25_watched_actions
where 1 = 1
