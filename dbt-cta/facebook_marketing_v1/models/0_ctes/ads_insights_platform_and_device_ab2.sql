...
-- depends_on: {{ ref('ads_insights_platform_and_device_ab1') }}
select
    ...
    cost_per_ad_click,
    cost_per_thruplay,
    cast(impression_device as {{ dbt_utils.type_string() }}) as impression_device,
    cast(optimization_goal as {{ dbt_utils.type_string() }}) as optimization_goal,
    cast(platform_position as {{ dbt_utils.type_string() }}) as platform_position,
    cast(inline_link_clicks as {{ dbt_utils.type_bigint() }}) as inline_link_clicks,
    cast(publisher_platform as {{ dbt_utils.type_string() }}) as publisher_platform,
    video_play_actions,
