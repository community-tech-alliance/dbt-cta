...
-- depends_on: {{ ref('ads_insights_platform_and_device_video_continuous_2_sec_watched_actions_ab1') }}
select
...
from {{ ref('ads_insights_platform_and_device_video_continuous_2_sec_watched_actions_ab1') }}
