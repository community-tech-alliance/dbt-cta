...
left join {{ ref('ads_insights_platform_and_device_cost_per_thruplay_ab2') }} as cost_per_thruplay
  on cost_per_thruplay._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_continuous_2_sec_watched_actions_ab2') }} as video_continuous_2_sec_watched
  on video_continuous_2_sec_watched._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_cost_per_2_sec_continuous_video_view_ab2') }} as cost_per_2_sec_continuous_video_view
  on cost_per_2_sec_continuous_video_view._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_cost_per_15_sec_video_view_ab2') }} as cost_per_15_sec_video_view
  on cost_per_15_sec_video_view._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_15_sec_watched_actions_ab2') }} as video_15_sec_watched
  on video_15_sec_watched._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_30_sec_watched_actions_ab2') }} as video_30_sec_watched
  on video_30_sec_watched._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_p25_watched_actions_ab2') }} as video_p25_watched
  on video_p25_watched._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_p50_watched_actions_ab2') }} as video_p50_watched
  on video_p50_watched._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_p75_watched_actions_ab2') }} as video_p75_watched
  on video_p75_watched._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_p95_watched_actions_ab2') }} as video_p95_watched
  on video_p95_watched._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_p100_watched_actions_ab2') }} as video_p100_watched
  on video_p100_watched._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_website_ctr_ab2') }} as website_ctr
  on website_ctr._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_video_play_actions_ab2') }} as video_played
  on video_played._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
left join {{ ref('ads_insights_platform_and_device_actions_ab2') }} as landing_page_views
  on landing_page_views._airbyte_ads_insights_platform_and_device_hashid = insights._airbyte_ads_insights_platform_and_device_hashid
