...
-- depends_on: {{ source('cta', '_airbyte_raw_discounts') }}
select
    ...
    {{ json_extract('table_alias', '_airbyte_data', ['discount_data'], ['discount_data']) }} as discount_data,
...
from {{ source('cta', '_airbyte_raw_discounts') }} as table_alias
-- discounts
where 1 = 1
