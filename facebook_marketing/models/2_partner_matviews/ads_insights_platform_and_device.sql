...
SELECT
    ...
    --PLATFORM AND DEVICE
    ,MAX(publisher_platform) as publisher_platform
    ,MAX(platform_position) as platform_position
    ,MAX(impression_device) as impression_device
    --METRICS
    ,MAX(cpc) as cpc
    ,MAX(cpm) as cpm
    ,MAX(cpp) as cpp
    ...
    ,MAX(video_30_sec_watched_actions) as video_30_sec_watched_actions
...
GROUP BY _airbyte_ads_insights_platform_and_device_hashid