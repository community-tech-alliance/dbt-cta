...
-- depends_on: {{ ref('ads_insights_platform_and_device_cost_per_15_sec_video_view_ab1') }}
select
...
from {{ ref('ads_insights_platform_and_device_cost_per_15_sec_video_view_ab1') }}
