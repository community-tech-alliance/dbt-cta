...
{{ unnest_cte(ref('ads_insights_overall_ab3'), 'ads_insights_overall_ab3', 'video_p100_watched_actions') }}
select
...
{{ cross_join_unnest('ads_insights_overall_ab3', 'video_p100_watched_actions') }}
where 1 = 1
