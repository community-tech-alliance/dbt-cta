...
),  __dbt__cte__group_members_ab3 as (
...
-- depends_on: __dbt__cte__group_members_ab3
select
    id,
    kind,
    role,
...
from __dbt__cte__group_members_ab3
-- group_members from `prod8b61f23e`.cta_tech_app_users._airbyte_raw_group_members
where 1 = 1
...
and cast(_airbyte_emitted_at as 
    ...
    cast('2022-12-02 10:00:40+00:00' as 
    timestamp
)
