...
),  __dbt__cte__users_externalIds_ab3 as (
...
-- depends_on: __dbt__cte__users_externalIds_ab3
select
    _airbyte_users_hashid,
    type,
    value,
...
from __dbt__cte__users_externalIds_ab3
-- externalIds at users/externalIds from `prod8b61f23e`.cta_tech_app_users.`users`
where 1 = 1
