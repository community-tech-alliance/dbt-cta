...
-- depends_on: __dbt__cte__users_name_ab3
select
    _airbyte_users_hashid,
    fullName,
    givenName,
...
from __dbt__cte__users_name_ab3
-- name at users/name from `prod8b61f23e`.cta_tech_app_users.`users`
where 1 = 1
