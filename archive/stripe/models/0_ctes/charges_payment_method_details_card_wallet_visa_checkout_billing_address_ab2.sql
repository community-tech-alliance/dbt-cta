...
-- depends_on: {{ ref('charges_payment_method_details_card_wallet_visa_checkout_billing_address_ab1') }}
select
...
from {{ ref('charges_payment_method_details_card_wallet_visa_checkout_billing_address_ab1') }}
